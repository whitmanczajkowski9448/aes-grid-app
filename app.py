...
PRESET_EVENT_BUTTON_ROWS = [
    [
        ...
        {"label": "AAU Wave 5 (Boys)", "url": "https://results.advancedeventsystems.com/event/PTAwMDAwNDUwMzI90/court-schedule", "active": True},
        {"label": "AAU Wave 5 (Girls)", "url": "https://results.advancedeventsystems.com/event/PTAwMDAwNDUwMzA90/court-schedule", "active": True},
        {"label": "AAU Wave 6 (Boys)", "url": "", "active": False},
        {"label": "AAU Wave 6 (Girls)", "url": "", "active": False},
    ],
    [
        {
            "label": "AAU Wave 5 (Boys and Girls)",
            "urls": [
                "https://results.advancedeventsystems.com/event/PTAwMDAwNDUwMzI90/court-schedule",
                "https://results.advancedeventsystems.com/event/PTAwMDAwNDUwMzA90/court-schedule",
            ],
            "active": True,
        },
        {
